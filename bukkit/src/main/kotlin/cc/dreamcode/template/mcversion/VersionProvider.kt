...
object VersionProvider {
    val versionAccessor: VersionAccessor
        get() = when (ReflectionUtils.VERSION) {
            "cc/dreamcode/template/mcversion/v1_8_R3" -> {
                V1_8_R3_VersionAccessor()
            }
            "cc/dreamcode/template/mcversion/v1_12_R1" -> {
                V1_12_R1_VersionAccessor()
            }
            "cc/dreamcode/template/mcversion/v1_16_R3" -> {
                V1_16_R3_VersionAccessor()
            }
            "cc/dreamcode/template/mcversion/v1_17_R1" -> {
                V1_17_R1_VersionAccessor()
            }
            "cc/dreamcode/template/mcversion/v1_18_R2" -> {
                V1_18_R2_VersionAccessor()
            }
            "cc/dreamcode/template/mcversion/v1_19_R2" -> {
