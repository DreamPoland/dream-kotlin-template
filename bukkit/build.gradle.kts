...
dependencies {
    ...
    // -- dream-menu --
    implementation("cc.dreamcode.menu:core:0.4.5")
    implementation("cc.dreamcode.menu:bukkit:0.4.5")
    implementation("cc.dreamcode.menu:serdes-bukkit:0.4.5")
    implementation("cc.dreamcode.menu:serdes-bukkit-okaeri:0.4.5")
}
