...
dependencies {
    ...
    implementation("cc.dreamcode.platform:cli:1.4.1")
...
tasks.withType<ShadowJar> {
    archiveFileName.set("Dream-Template-Cli-${project.version}.jar")

    manifest {
        attributes["Main-Class"] = "cc.dreamcode.template.CliTemplateLauncher"
    }
